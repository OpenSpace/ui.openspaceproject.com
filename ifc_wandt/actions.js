...
async function setViewCupola2() {
  await setViewCupolaX({
    Aim: "Earth",
    Anchor: "ISSCupola",
    Pitch: -0.6589943385976632,
    Position: [0.3853912353515625,-0.10039520263671875,0.089111328125],
    ReferenceFrame: "Root",
    Up: [0.016053790169846094,0.6975060436526765,0.7163990472419496],
    Yaw: -0.4397801368512996
  });
}
